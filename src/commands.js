...
[["vrcdesktop", "vrchatdesktop"],
`**TL;DR:** Full Body Tracking is **not available** while playing VRChat in **desktop mode**, but you can use Amethyst to emulate a VR headset (see \`/hoshi diyvr\`).
